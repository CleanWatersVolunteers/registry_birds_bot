...
apm1_text_incorrect_data = "Неверная дата или время(дата должна быть вчерашней либо сегодняшней):"
# apm1_text_incorrect_data = "Дата должна быть вчерашней либо сегодняшней:"
